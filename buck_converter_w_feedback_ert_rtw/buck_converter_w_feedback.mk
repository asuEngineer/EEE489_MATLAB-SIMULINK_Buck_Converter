...
## Generated on : Fri Mar 07 12:07:18 2025
...
PRODUCT_NAME              = buck_converter_w_feedback
MAKEFILE                  = buck_converter_w_feedback.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/buck_converter_w_feedback.elf
...
%.o : $(START_DIR)/buck_converter_w_feedback_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/buck_converter_w_feedback_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/buck_converter_w_feedback_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/buck_converter_w_feedback_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/buck_converter_w_feedback_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
buck_converter_w_feedback_data.o : $(START_DIR)/buck_converter_w_feedback_ert_rtw/buck_converter_w_feedback_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
