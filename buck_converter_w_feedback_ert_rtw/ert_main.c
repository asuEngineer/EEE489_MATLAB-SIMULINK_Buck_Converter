...
int main(void)
{
  ...
  errorCode = extmodeInit(buck_converter_w_feedback_M->extModeInfo,
    &rtmGetTFinal(buck_converter_w_feedback_M));
  if (errorCode != EXTMODE_SUCCESS) {
  ...
  if (errorCode == EXTMODE_SUCCESS) {
    ...
    if (extmodeStopRequested()) {
      rtmSetStopRequested(buck_converter_w_feedback_M, true);
    }
  }
