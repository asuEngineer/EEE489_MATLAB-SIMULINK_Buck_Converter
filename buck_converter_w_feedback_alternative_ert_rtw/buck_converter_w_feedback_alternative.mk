###########################################################################
## Makefile generated for component 'buck_converter_w_feedback_alternative'. 
## 
## Makefile     : buck_converter_w_feedback_alternative.mk
## Generated on : Wed Feb 26 19:36:58 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/buck_converter_w_feedback_alternative.elf
...
PRODUCT_NAME              = buck_converter_w_feedback_alternative
MAKEFILE                  = buck_converter_w_feedback_alternative.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/buck_converter_w_feedback_alternative.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -IC:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinobase/include -I$(START_DIR)/buck_converter_w_feedback_alternative_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(ARDUINO_RP2040_ROOT)/hardware/rp2040/$(ARDUINO_RP2040_LIB_VERSION)/cores/rp2040 -I$(ARDUINO_RP2040_ROOT)/hardware/rp2040/$(ARDUINO_RP2040_LIB_VERSION)/cores/rp2040/sdkoverride -I$(VARIANT_HEADER_PATH) -IC:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinotarget/include -IC:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinotarget/scheduler/include -I$(MATLAB_ROOT)/toolbox/target/shared/armcortexmbase/scheduler/include -I$(MATLAB_ROOT)/toolbox/target/shared/armcortexmbase/xcp/include
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_TIMESTAMP_BASED_ON_SIMULATION_TIME -DXCP_SET_MTA_SUPPORT -DEXTMODE_XCP_TRIGGER_SUPPORT -DXCP_MEM_BLOCK_1_SIZE=32 -DXCP_MEM_BLOCK_1_NUMBER=1 -DXCP_MEM_BLOCK_2_SIZE=56 -DXCP_MEM_BLOCK_2_NUMBER=1 -DXCP_MEM_BLOCK_3_SIZE=56 -DXCP_MEM_BLOCK_3_NUMBER=1 -DXCP_MEM_RESERVED_POOLS_TOTAL_SIZE=975 -DXCP_MEM_RESERVED_POOLS_NUMBER=2 -DXCP_MEM_DAQ_RESERVED_POOL_BLOCKS_NUMBER=3 -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=1 -DXCP_MIN_EVENT_NO_RESERVED_POOL=1 -DXCP_MAX_CTO_SIZE=255 -DXCP_MAX_DTO_SIZE=65532 -DXCP_MAX_ODT_ENTRY_SIZE=255 -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=65536 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=0
...
DEFINES_STANDARD = -DMODEL=buck_converter_w_feedback_alternative -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o xcp_ext_mode.o buck_converter_w_feedback_alternative.o buck_converter_w_feedback_alternative_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o boot2_w25q080_2_padded_checksum.S.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plus_RP2040_Scheduler.o MW_arduinoNanoRP2040_multitasking.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/buck_converter_w_feedback_alternative_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/buck_converter_w_feedback_alternative_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/buck_converter_w_feedback_alternative_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/buck_converter_w_feedback_alternative_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/buck_converter_w_feedback_alternative_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
buck_converter_w_feedback_alternative.o : $(START_DIR)/buck_converter_w_feedback_alternative_ert_rtw/buck_converter_w_feedback_alternative.c
	$(CC) $(CFLAGS) -o "$@" "$<"


buck_converter_w_feedback_alternative_data.o : $(START_DIR)/buck_converter_w_feedback_alternative_ert_rtw/buck_converter_w_feedback_alternative_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/buck_converter_w_feedback_alternative_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
